...
# Create items
Potion = Item("Potion", "HPpotion", "Heals 50 HP", 50)
SuperPotion = Item("SuperPotion", "HPpotion", "Heals 150 HP", 150)
Elixer = Item("Elixer", "elixer", "Fully restores HP/MP", 9999)
ManaPotion = Item("ManaPotion", "MPpotion", "Restore 50 MP", 50)
...
# Things that look bad but keep the code alive
b = 0
mageCount = 0
warriorCount = 0
AssassinCount = 0
